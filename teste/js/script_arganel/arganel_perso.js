$(document).ready(function(){
  ...
  $('#u2386').click(function(){ $('#cor_fundo').val('azul claro'); });
  ...
  $('#u2424').click(function(){ $('#cor_borda').val('rosa'); });
  ...
  $('#u2415').click(function(){ $('#cor_borda').val('lilas'); });
  ...
  $('#u2473').click(function(){ $('#cor_logo').val('rosa'); });
  ...
  $('#u2495').click(function(){ $('#cor_espada').val('rosa'); });
  ...
  $('#u2498').click(function(){ $('#cor_espada').val('lilas'); });
 ...
 $('#u15523-4').click(function(){
  ...
  /* alert(cor_fundo);
   ...
   if($.isNumeric(quant_arganel)){
     ...
     }else{ alert('Por favor digite valores maior que 0'); }
